...
async def on_ready():
    ...
    scheduler.add_job(calculate_ma_scheduled, 'cron', day_of_week='sun,mon,tue,wed,thu', hour=20, minute=15)
    scheduler.add_job(stock_price_notification, 'cron', day_of_week='sun,mon,tue,wed,thu', hour=20, minute=16)
    scheduler.add_job(check_watchlist, 'cron', day_of_week='sun,mon,tue,wed,thu', hour=20, minute=17)
    scheduler.add_job(check_news, 'cron', day_of_week='sun,mon,tue,wed,thu', hour=20, minute=18)
    scheduler.start()
